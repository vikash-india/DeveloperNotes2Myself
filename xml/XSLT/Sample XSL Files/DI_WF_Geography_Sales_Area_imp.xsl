...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xt="http://schemas.dendrite.com/IS/1.0.0/Geography_Sales_Area" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:di="http://www.dendrite.com/2004/XTelligent/DataloadInterface" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
	...
	<xsl:template match="//*">
		<xsl:variable name="TeamCnt" select="count(//*[@type_name='Geography_Sales_Area'])"/>
		<xsl:copy>
			...
			<xsl:if test="$TeamCnt > 0">
				<xsl:for-each select="//*[@type_name='Geography_Sales_Area'] ">
