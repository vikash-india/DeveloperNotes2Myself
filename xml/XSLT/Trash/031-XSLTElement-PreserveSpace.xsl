...
<!-- 
	Definition: The <xsl:preserve-space> element is used to define the elements for which white space should be preserved.
	...
	Notes: 
		1. The <xsl:strip-space> element is used to define the elements for which white space should be removed.
