...
### Legend
* ![c] : Commercial Library
* ![w] : Widely Used Library
* ![u] : I have used this library
* ![f] : Favourite Library
* ![e] : Yet To Explore

<!--- Images used in the Legend above --->

[c]: images/java-libraries-icon-1-dollar-commercial-library.png
[w]: images/java-libraries-icon-2-up-arrow-widely-used-library.png
[u]: images/java-libraries-icon-3-tick-i-have-used-library.png
[f]: images/java-libraries-icon-4-heart-my-favourite-library.png
[e]: images/java-libraries-icon-5-star-yet-to-explore-library.png

### Note
* Credit and Primary Source: [Awesome Java on Github](https://github.com/akullpp/awesome-java)
