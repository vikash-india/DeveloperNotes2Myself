// Description: Scope, Visibility and Lifetime of an identifier (variables, parameters, function etc.) in JavaScript
...
//      - Lifetime of an identifier is the period during execution of a program in which an identifier exists in memory.
//        In other words, the storage duration of an identifier determines its lifetime.
...
//        together in a common global namespace.
...
//      - Functional Scope: All identifiers in JavaScript have FUNCTIONAL scope. In JavaScript, blocks do NOT have
//        scopes but functions have scopes. An identifier declared anywhere in a function is available everywhere in
//        the function.
//      - In many modern languages, it is recommended that variables be declared as late as possible, at the first
//        point of use. That turns out to be bad advice for JavaScript because it lacks block scope. So instead, it is
