...
// 1. Functions that are intended to be used with the new prefix are called constructors. By convention, they are kept
//    in variables with a capitalised name. If a constructor is called without the new prefix, very bad things can
//    happen without a compile-time or runtime warning, so the capitalisation convention is really important.
...
console.log("The Constructor Invocation Pattern is JS bad parts.");
