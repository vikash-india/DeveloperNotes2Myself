// Description: Objects retrievals in JavaScript
...
// Object Retrieval
// 1. Suffix([ ]) Notation: Values can be retrieved from an object by wrapping a string expression in a [ ] suffix.
...
// reserved word, then the . notation can be used. The . notation is preferred because it is more compact and it
// reads better.
